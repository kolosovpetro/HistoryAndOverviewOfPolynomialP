...
\title[History And Overview Of Polynomial \texorpdfstring{$\polynomialP{m}{b}{x}$}{P[m,b,x]}]
{History And Overview Of Polynomial \texorpdfstring{$\polynomialP{m}{b}{x}$}{P[m,b,x]}}
\author[Petro Kolosov]{Petro Kolosov}
\address{Software Developer, DevOps Engineer}
\email{kolosovp94@gmail.com}
\urladdr{https://kolosovpetro.github.io}
\keywords{
    Polynomials, Finite differences, Interpolation, Polynomial identities
}
...
\hypersetup{
    ...
    pdfsubject={
        Polynomials, Finite differences, Interpolation, Polynomial identities, Power sums
    },
...
%    \input{sections/02_introduction}
    ...
    \section{History and evolution of the topic}\label{sec:history-and-evolution-of-the-topic}
    \input{sections/03_history_and_evolution}


    \section{Related works}\label{sec:related-works}
    \input{sections/04_related_works}
