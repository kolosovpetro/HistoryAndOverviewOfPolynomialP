In this section we provide a short overview of related works that are based
onto the main results of~\cite{kolosov2016link} mainly focusing on the polynomial $\polynomialP{m}{b}{x}$
\begin{figure}[H]
    \centering
