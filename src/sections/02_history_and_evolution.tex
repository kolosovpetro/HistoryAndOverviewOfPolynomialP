...
\end{equation}
It is immediately seen that~\eqref{eq:cube_identity} holds looking to the table of its values (oeis citation)
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Values of . See the OEIS entry: \href{https://oeis.org/A287326}{\texttt{A287326}}.}
    \label{tab:fig_1}
\end{table}
Therefore, we have reached our base case,
