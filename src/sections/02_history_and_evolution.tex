...
It was proposed that case for $n^5$ has the explicit form
\begin{equation*}
...
\end{equation*}
Observing the equation above, the potential form generalized of odd-power identity becomes more obvious.
...
can be generalized for all odd-powers $2m+1$ by constructing and solving a system of linear equations,
so that generalized form of the relation~\eqref{eq:cube_identity} appears to be
\begin{equation}
